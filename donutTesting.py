...
# This function is like the builtin range function but it accepts floats as steps
...
#
# # VideoWriter Object
# vid = cv2.VideoWriter(file,codec,fps,resolution)
...
with mp_hands.Hands(max_num_hands=2, min_detection_confidence=0.8, min_tracking_confidence=0.6) as hands:
    ...
    while video.isOpened():
        ...
        # Resize the frame
        frame = resize(frame,width=1000, height=1000)
        ...
        if landmarks.multi_hand_landmarks:
            ...
            for hand in landmarks.multi_hand_landmarks:
                ...
                if get_label(index,hand, landmarks):
                    ...
                    # Find the number of fingers on detected hand
                    num_of_fingers = fingers_count(hand,hand_indicator[:4 if hand_indicator == "Left " else 5])
